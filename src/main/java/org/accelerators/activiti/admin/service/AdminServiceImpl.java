...
public class AdminServiceImpl implements AdminService {
	...
	public void refreshUsers() {
		...
		for (User user : getIdentityService().createUserQuery().orderByUserId()
				.asc().list()) {
	...
	public void refreshGroups() {
		...
		for (Group group : getIdentityService().createGroupQuery()
	...
	public Set<String> getGroupMembers(String groupId) {
		...
		for (User user : getIdentityService().createUserQuery()
	...
	public Set<String> getAssignedTaskIds(String id) {
		...
		for (Task task : getTaskService().createTaskQuery().taskAssignee(id)
	...
	public Set<String> getUnassignedTaskIds(String id) {
		...
		for (Task task : getTaskService().createTaskQuery()
				.taskCandidateUser(id).orderByTaskCreateTime().desc().list()) {
	...
	public Set<String> getUnassignedTaskIdsByGroup(String id) {
		...
		// Get all task ids
		for (Task task : getTaskService().createTaskQuery()
				.taskCandidateGroup(id).orderByTaskCreateTime().desc().list()) {
			unassignedTasks.add(task.getId());
		}
	...
	private User getUser(String id) {
		...
		// Get user
		return (User) getIdentityService().createUserQuery().userId(id)
				.singleResult();
	...
	private Group getGroup(String id) {
		...
		// Get group
		return (Group) getIdentityService().createGroupQuery().groupId(id)
				.singleResult();

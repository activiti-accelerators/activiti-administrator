...
public class GroupEditForm extends Form implements ClickListener {
	...
	public void setItemDataSource(Item item) {
		...
		if ((item != null)
				&& (getItemDataSource().getItemProperty("id") != null)
				&& !getItemDataSource().getItemProperty("id").toString()
						.isEmpty()) {

			// Add group members
			members.setValue(app.getAdminService().getGroupMembers(
					getItemDataSource().getItemProperty("id").toString()));
		...
		if (source == save) {
			...
			try {
				...
				app.getMainWindow().showNotification(
						app.getMessage(Messages.GroupUpdatedMessage)
